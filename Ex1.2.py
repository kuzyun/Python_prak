...
def Tr1Plain(X, N1, Tr1):
    d1 = - numpy.dot(N1, [i**2 for i in Tr1[0]])
    return numpy.dot(N1, X) + d1

def Tr2Plain(X, N2, Tr2):
    d2 = - numpy.dot(N2, [i**2 for i in Tr2[0]])
    return numpy.dot(N2, X) + d2

def VecAbs(vector):
    return cmath.sqrt(vector[0] * vector[0] + vector[1] * vector[1] + vector[2] * vector[2]).real

def IsCrossed(Tr2, Tr1):
    i = 0
    N1 = 0
    N2 = 0
    N1 = numpy.cross([Tr1[1][0]**2 - Tr1[0][0]**2, Tr1[1][1]**2 - Tr1[0][1]**2, Tr1[1][2]**2 - Tr1[0][2]**2],
                     [Tr1[2][0]**2 - Tr1[0][0]**2, Tr1[2][1]**2 - Tr1[0][1]**2, Tr1[2][2]**2 - Tr1[0][2]**2])
